...
// Функция сортировки массива возвращает отсортированный массив
...
// Функция где всё соеденено воединно, выводит текст в элемент
/*
@elemId - для ввода id контейнера, блока в котором будет размещаться "Карта путешествий"
...
Сначала очищает блок с id = @elemId, затем переменной cards присваевается ответ функции cardTest();  В случае нахождения ошибки вернет числовое значение, иначе не отсортированный массив карточек. Далее выполняеся фнкция поиска ошибок отчета об ошибке, если переменная cards равно заданному значению из switch то возвращает номер ошибки и сообщение, иначе выполняется функция sort() и выводится ОТСОРТИРОВАННЫЙ массив карточек. Возврат значения cards;
*/
